...
function create(data) {
    ...
    for (let i=0; i<SHIPMENTS.length; i++) {
        ...
        doc.altText(TABLE_X_POS[0] + c2offset, posY, `${date.getMonth()+1} / ${date.getDate()}`, DEFAULT_FONT_SIZE-2);
        doc.altText(TABLE_X_POS[1] + c2offset, posY, shipment[TABLE_KEYS[1]], DEFAULT_FONT_SIZE-2);
        doc.altText(TABLE_X_POS[2] + c2offset, posY, shipment[TABLE_KEYS[2]], DEFAULT_FONT_SIZE-2);
        doc.altText(TABLE_X_POS[3] + c2offset, posY, `${shipment.dept} ${shipment.unit}`, DEFAULT_FONT_SIZE-2);
        posY += 4;
    }
